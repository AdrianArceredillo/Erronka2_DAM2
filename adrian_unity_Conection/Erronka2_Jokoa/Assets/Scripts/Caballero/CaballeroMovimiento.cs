...
public class CaballeroMovimiento : MonoBehaviour
{
    public GameObject ataque1;  //tecla F
    //public GameObject ataque2;  //tecla E
    //public GameObject ataque3;  //tecla R
    ...
    public void movimientosPlayer()
    {
        ...
        if (Input.GetKeyDown(KeyCode.F))
        {
            ...
            ataque1.gameObject.transform.position = personaje.gameObject.GetComponent<Rigidbody2D>().transform.position;

            ataque1.gameObject.SetActive(true);
    ...
    {
        //desactivar disparos
        ataque1.gameObject.SetActive(false);
        //activar personaje
